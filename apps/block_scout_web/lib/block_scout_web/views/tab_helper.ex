defmodule ExplorerWeb.TabHelper do
  @moduledoc """
  ...
  * returns nil if the tab is not active.
  ...
  iex> ExplorerWeb.TabHelper.tab_status("token", "/page/0xSom3tH1ng/token")
  "active"

  iex> ExplorerWeb.TabHelper.tab_status("token", "/page/0xSom3tH1ng/token_transfer")
  nil
  """
  ...
  * returns nil if the tab name is not in the path.
  ...
  iex> ExplorerWeb.TabHelper.tab_active?("token", "/page/0xSom3tH1ng/token")
  true

  iex> ExplorerWeb.TabHelper.tab_active?("token", "/page/0xSom3tH1ng/token_transfer")
  false
  """
