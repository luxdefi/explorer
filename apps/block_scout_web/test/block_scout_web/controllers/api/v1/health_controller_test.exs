defmodule ExplorerWeb.API.V1.HealthControllerTest do
  ...
  describe "GET last_block_status/0" do
    ...
    test "returns error when last block is stale", %{conn: conn} do
      ...
      assert %{
               ...
               "error_description" =>
                 "There are no new blocks in the DB for the last 5 mins. Check the healthiness of Ethereum archive node or the Explorer DB instance",
               "data" => %{
