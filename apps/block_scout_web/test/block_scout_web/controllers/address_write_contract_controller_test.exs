defmodule ExplorerWeb.AddressWriteContractControllerTest do
  ...
  describe "GET index/3" do
    ...
    test "with invalid address hash", %{conn: conn} do
      conn = get(conn, address_write_contract_path(ExplorerWeb.Endpoint, :index, "invalid_address"))
    ...
    test "with valid address that is not a contract", %{conn: conn} do
      ...
      conn = get(conn, address_write_contract_path(ExplorerWeb.Endpoint, :index, Address.checksum(address.hash)))
    ...
    test "successfully renders the page when the address is a contract", %{conn: conn} do
      ...
      conn =
        get(conn, address_write_contract_path(ExplorerWeb.Endpoint, :index, Address.checksum(contract_address.hash)))
